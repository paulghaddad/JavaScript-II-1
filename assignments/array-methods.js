...
let fullNamesForEach = []
runners.forEach(runner => {
  fullNamesForEach.push(`${runner.first_name} ${runner.last_name}`)
})
console.log(fullNamesForEach)

const fullName = runners.map(runner => `${runner.first_name} ${runner.last_name}`)
